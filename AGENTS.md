...
This project is indexed by GitNexus as **autoortho-rs** (2406 symbols, 4802 relationships, 158 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
